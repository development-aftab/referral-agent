...
<style>
        ...
        .head {min-height: 107px;display: flex;justify-content: center;align-items: center;}

        /* width */
        .abiity ul::-webkit-scrollbar {
            width: 4px;
        }

        /* Track */
        .abiity ul::-webkit-scrollbar-track {
            background: #f1f1f1;
        }

        /* Handle */
        .abiity ul::-webkit-scrollbar-thumb {
            background: #f60;
        }

        /* Handle on hover */
        .abiity ul::-webkit-scrollbar-thumb:hover {
            background: #555;
        }
            ...
            <div class="row">
                            ...
                            <div class="card_body">
                                ...
                                <div class="content">
                                    ...
                                    <div class="card_price">
                                        ...
                                        <a href="{{ route('sign_up') }}/basic/0" class="btn card_btn">Get Started</a>
                                    </div>
                                </div>
                                <div class="wave">
                ...
                <div class="col-md-4">
                    <div class="memb_cards">
                        <div class="memb_card">
                            <div class="head">
                                <h3>PREMIUM MONTHLY MEMBERSHIP</h3>
                            </div>
                            <div class="card_body">
                                <div class="card_icon">
                                ...
                                <div class="content">
                                    ...
                                    <div class="card_price">
                                        ...
                                        <a href="{{ route('sign_up') }}/monthly/10" class="btn card_btn">Get Started</a>
                                    </div>
                                </div>
                                <div class="wave">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="351.226" height="422.211"
                ...
                <div class="col-md-4">
                    <div class="memb_cards">
                        <div class="memb_card">
                            <div class="head">
                                <h3>PREMIUM ANUALLY MEMBERSHIP</h3>
                            </div>
                            <div class="card_body">
                                <div class="card_icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="92.112" height="187.279"
                                ...
                                <div class="content">
                                    <div class="abiity">
                                        <ul>
                                            ...
                                            <li><span><i class="fal fa-check-double"></i></span>Market your business on site</li>
                                            <li><span><i class="fal fa-check-double"></i></span>Display headshot and logo on profile</li>
                                            <li><span><i class="fal fa-check-double"></i></span>Billed annually, cancel anytime</li>
                                        </ul>
                                    </div>
                                    <div class="card_price">
                                        <h5>$99.99
                                        ...
                                        <a href="{{ route('sign_up') }}/yearly/100" class="btn card_btn">Get Started</a>
                                    </div>
                                </div>
                                <div class="wave">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="351.226" height="422.211"

        ...
        <section style="padding: 80px 0;">
            <div style="display: block;">
                ...
                <div style="width: 100%; max-width: 50%; color: #000; margin: 0 auto; box-shadow: 0 0 10px lightgray; padding: 50px; border-radius: 10px;">
                    <div>
                        <h3>Thank you for enrolling with Referral-Agent.com!</h3>
                    </div>
                    ...
                    <div style="">
                        <p style="margin-bottom: 0;">Please tell any other real estate professionals who may accept referrals about our site.  If you have any questions or comments, please email us at <a href="mailto:admin@referral-agent.com"> admin@referral-agent.com</a>.!</p>
                    </div>
                    <div style="">

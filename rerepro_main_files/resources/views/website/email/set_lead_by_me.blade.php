        ...
        <section style="padding: 80px 0;">
            <div style="display: block;">
                ...
                <div style="width: 100%; max-width: 50%; color: #000; margin: 0 auto; box-shadow: 0 0 10px lightgray; padding: 50px; border-radius: 10px;">
                    <div>
                        <h3>You have sent a new lead from to a real estate professional on Referral-Agent.com  </h3>
                    </div>
                    ...
                    <div style="">
                        <p style="margin-bottom: 0;">Please log in anytime to see and track your lead</p>
                    </div>
                    <div style="">

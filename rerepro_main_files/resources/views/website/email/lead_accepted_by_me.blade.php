        ...
        <section style="padding: 80px 0;">
            <div style="display: block;">
                ...
                <div style="width: 100%; max-width: 50%; color: #000; margin: 0 auto; box-shadow: 0 0 10px lightgray; padding: 50px; border-radius: 10px;">
                    <div>
                        <h3>You have successfully passed a new lead to an agent on Referral-Agent.com and they have accepted the lead! </h3>
                    </div>
                    <div style="padding: 10px 0;">
                        ...
                        <p style="display: inline-block;margin-bottom: 0; width: 180px; margin-top: 0; word-break: break-word; vertical-align: top;">{{ $data_me['email'] }}</p>
                    </div>
                   
                    <div style="">
                        <p style="margin-bottom: 0;">Please log in anytime to see and track your referral.  Attached is a PDF of the referral agreement for your records.</p>
                    </div>
                    <div style="">

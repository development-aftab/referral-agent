      ...
      font-size: 14px;
                        ...
                        <a class="btn btn-info" href="javascript:genPDF()">Download PDF</a> 
                          ...
                          <div class="body">
                                 ...
                                 <span style="font-size:50px; text-transform: uppercase; font-weight:bold;margin-bottom: 20px;">Referral Agreement</span>
                                 <br>
                                 <div style="display: flex; justify-content: space-between; width: 100%; max-width: 93%; margin: 0 auto;">
                                      <div style="text-align: left; width: 350px; line-height: 25px; margin-bottom: 30px;">
                                          
                                          <h2 style="margin-bottom: 5px; font-weight: 800; text-transform: uppercase;      line-height: 36px;
    font-size: 24px;  color: #333b3f;">Referring Agent Information</h2>
                                      ...
                                      <div style="text-align: left; width: 350px; line-height: 25px;margin-bottom: 30px;">
                                          <h2 style="margin-bottom: 5px; font-weight: 800; text-transform: uppercase; line-height: 36px;
    font-size: 24px;  color: #333b3f;">Receiving Agent Information</h2>
                                          <span style="font-weight: 700">Name: </span>
               {{ $lead->name }}</span>
                                          <br>
                                          <span style="font-weight: 700">Address: </span>
               {{ $lead->profile->agent_address }}</span>
                                          <br> 
                                          <span style="font-weight: 700">Brokerage/Company: </span>
               {{ $lead->profile->brokerage_company }}</span>
                                          <br>
                                          <span style="font-weight: 700">Phone: </span>
               {{ $lead->profile->phone }}</span>
                                          <br>
                                          <span style="font-weight: 700">Email: </span>
               {{ $lead->email }}</span>
                                          <br>
                                          <span style="font-weight: 700">License Number: </span>
               {{ $lead->profile->license_number }}</span>
                                          <br>
                                          <span style="font-weight: 700">License State: </span>
               {{ $lead->profile->license_state }}</span>
                                          <br>
                                          <span style="font-weight: 700">Agent Website: </span>
               {{ $lead->profile->agent_website }}</span>
                                          <br>
                                          <span style="font-weight: 700">Managing Broker: </span>
               {{ $lead->profile->managing_broker_name }}</span>
                                 ...
                                 <div style="width: 100%; text-align: left; max-width: 93%; margin: 0 auto">
                                  <h2 style="margin-bottom: 5px; font-weight: 800; text-transform: uppercase; line-height: 36px;
    font-size: 24px;  color: #333b3f;">Lead information</h2>
                                     <div class="lead_info">
                                        <span style="font-weight: 700">Name: </span>
                                        <span></span>
                                     </div>
                              ...
                              <div style="width: 100%; text-align: left; max-width: 93%; margin: 0 auto">
                                  <h2 style="margin-bottom: 5px; font-weight: 800; text-transform: uppercase; line-height: 36px;
    font-size: 24px;  color: #333b3f;">Acknowledged by:</h2>
                                  <div class="ackn_div">
                                      <div>
                                      <span style="font-weight: 700">Referring Agent:</span>
                                      <span>@if($lead->sender_sing == 1)
                                              <img style=" width: 150px; height: 70px;" src="">
                                          @endif</span>
                                      </div>
                                      <div>
                                  ...
                                  <div class="ackn_div">
                                    <div>
                                      ...
                                      <span>
                                              <img style=" width: 150px; height: 70px;" src="{{ $lead->profile->signature }}">
                                          </span>
                                    </div>
                                      <div>
               ...
               {{ $lead->email }}</span>
                                 ...
                                 {{--<div style="display: inline-block; position: relative;">--}}
                                   {{--@if($lead->receiver_sing == 1)--}}
                                    {{--<img style="display: block; w{{ $lead->profile->signature }}">--}}
                                   {{--@endif --}}

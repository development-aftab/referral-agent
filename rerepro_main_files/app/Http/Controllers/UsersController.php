...
//            'postal' => 'required',
    ...
    public function saveSettings(Request $request){
        ...
        if($request->file('logo')){
            $profile->logo =Storage::disk('website')->put('images',$request->logo??'');
        }
       
        $profile->user_id = $user->id;
        $profile->about_us = $request->about_us;
        $profile->brokerage_company_address = $request->brokerage_company_address;
        $profile->gender = $request->gender;
        $profile->phone = $request->phone;
        $profile->agent_website = $request->agent_website;
        $profile->brokerage_company = $request->brokerage_company;
        $profile->brokerage_company_phone = $request->brokerage_company_phone;
        $profile->license_number = $request->license_number;
        $profile->license_state = $request->license_state;
        $profile->managing_broker_name = $request->managing_broker_name;
        $profile->dob = $date;
        $profile->country = $request->country;
        $profile->state = $request->state;
        $profile->city = $request->city;
